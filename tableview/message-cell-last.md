...
![](../LibrarypPictures/Snip20160616_1.png)

![](../LibrarypPictures/Snip20160616_2.png)

- 注意点2
    - 设置控件隐藏的时候注意类型
![](../LibrarypPictures/Snip20160616_3.png)
...
- 注意点3
    ...
    - 4再计算cell的高度
    - 计算之前都要强制更新
![](../LibrarypPictures/Snip20160616_5.png)
![](../LibrarypPictures/Snip20160616_4.png)

- 注意点4
    - 设置button的背景图片的拉伸
    - 设置button的内边距
![](../LibrarypPictures/Snip20160616_6.png)
![](../LibrarypPictures/Snip20160616_14.png)
- 注意点5, 返回cell的高度
    - 不要返回cell的预估高度, 会有bug
    - 在懒加载里边只用取出一个cell,传递模型
    - 算出cell的高度后, 模型就有高度属性了
![](../LibrarypPictures/Snip20160616_8.png)

- 注意点6
    - 怎么让textfiled的左边空出一个输入距离
![](../LibrarypPictures/Snip20160616_15.png)

- 注意点7
 - 设置键盘的弹出相应
![](../LibrarypPictures/Snip20160616_16.png)
